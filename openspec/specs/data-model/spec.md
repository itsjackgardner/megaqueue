...
- **WHEN** the download manager reports one file at 500MB/1.2GB and another at 200MB/800MB
...
- **WHEN** a download is created with a folder URL "https://mega.nz/folder/abc#key" and the download manager splits it into 3 files
