...
The system SHALL delete the temporary extraction directory after the rename step completes, whether or not it succeeded. Source files in `MEGABASTERD_DOWNLOAD_DIR` SHALL be removed by the organiser's move step and do not require separate cleanup.
